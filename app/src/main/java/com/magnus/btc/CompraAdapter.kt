...
class CompraAdapter (private val ativos: List<ComprasParce>):
...
//            val compras= ativos[vh.adapterPosition]
//            val it = Intent(parent.context, ComprasActivity::class.java)
//           it.putExtra("ativos",compra)
//           parent.context.startActivity(it)
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        holder.txtQuantidade.text= ativo.valor.toString()
